...
par(mfrow = c(2,2))
#Subplot1
plot(data$DT, data$Global_active_power, type = "s", ylab = "Global active power", xlab = "")
#Subplot2
plot(data$DT, data$Voltage, type = "s", ylab = "Voltage", xlab = "datetime")
#Subplot3
...
legend(x = "topright", 
       ...
       lwd = c(1,1,1))
#Subplot4
plot(data$DT, data$Global_reactive_power, type = "s", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()
